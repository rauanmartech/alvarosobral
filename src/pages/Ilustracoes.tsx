...
// Assets
import digitalShape from '@/assets/elements/digital-shape.webp';
          ...
          <div className="w-full px-6 py-12 lg:py-0 lg:h-full lg:min-h-[600px] flex items-center relative z-10">
            ...
            <div className="flex-1 z-10 flex flex-col items-center lg:items-start text-center lg:text-left">
              ...
              <div className="relative w-full">
                ...
                <h1 className="relative z-10 text-6xl md:text-8xl font-black font-outfit mb-6 leading-[0.9] text-white uppercase">
                  ARTE ONDE <br />
                  <span className="text-[hsl(var(--accent-orange))]">VOCÊ QUISER</span>
                </h1>
              </div>

              <p className="text-lg md:text-xl text-white/50 font-outfit mb-10 max-w-xl leading-relaxed">
                Colagens, objetos decorativos, ilustrações e prints são algumas das mídias que utilizo para expandir minha produção artística. Cada suporte oferece novas possibilidades de experimentação, narrativa e expressão.
              </p>
              ...
              <div className="flex flex-col md:flex-row items-center gap-6 mb-10 w-full lg:w-fit p-1">
                ...
                <div className="bg-white/5 border-2 border-dashed border-white/20 px-6 h-20 rounded-2xl flex flex-col justify-center min-w-[180px] w-full md:w-auto relative group overflow-hidden">
                  ...
                  <p className="text-white/30 text-[10px] font-black uppercase tracking-widest mb-1">Técnicas</p>
                  <p className="text-white font-bold font-outfit">Diversas</p>
                </div>
            ...
            <div className="relative w-full lg:absolute lg:top-0 lg:right-0 lg:h-full lg:w-1/2 flex justify-center items-center min-h-[350px] lg:min-h-0 z-0">
              ...
              <img 
                ...
                loading="eager"
                fetchPriority="high"
                className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10 w-[208px] h-auto md:w-full md:h-full object-contain object-center lg:scale-[0.92]"
              />
      ...
      <div className="container mx-auto px-6 pb-32">
        <div className="flex flex-col md:flex-row md:items-end justify-between items-center md:items-end text-center md:text-left mb-16 gap-6">
          <div className="flex flex-col items-center md:items-start">
            ...
            <p className="text-black/40 font-outfit mt-4 max-w-sm">Confira aqui alguns trabalhos feitos em diferentes técnicas.</p>
          </div>
